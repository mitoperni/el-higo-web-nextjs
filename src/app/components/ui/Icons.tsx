...
const Icons = {
  Location: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Phone: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  WhatsApp: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="currentColor"
      viewBox="0 0 24 24"
  ...
  Clock: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Instagram: ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg
      className={className}
      fill="currentColor"
      viewBox="0 0 24 24"
  ...
  Info: ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg
      className={className}
      fill="currentColor"
      viewBox="0 0 20 20"
  ...
  Map: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Document: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Star: ({ className = "w-5 h-5", filled = false, ...props }: IconProps) => (
    <svg
      className={className}
  ...
  Check: ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  ChevronDown: ({ className = "w-4 h-4", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  ChevronLeft: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  ChevronRight: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Menu: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Close: ({ className = "w-6 h-6", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  SearchPlus: ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
  ...
  Restaurant: ({ className = "w-5 h-5", ...props }: IconProps) => (
    <svg
      className={className}
      fill="none"
      stroke="currentColor"
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={2}
        d="M12 2l3.09 6.26L22 9l-5 4.95L18.18 22 12 17.77 5.82 22 7 13.95 2 9l6.91-.74L12 2z"
      />
    </svg>
  )
};
