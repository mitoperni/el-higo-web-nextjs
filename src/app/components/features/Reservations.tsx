          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="text-center">
                ...
                <p className="font-body text-dark-text text-sm">
                  {t("contact.hoursDetail")}
                </p>
                <p className="font-body text-green-leaf font-semibold text-sm mt-1">
                  {t("contact.closed")}
                </p>
              </div>
              ...
              <div className="bg-green-leaf text-white p-6">
                <div className="flex items-center">
                  ...
                  <h3 className="text-xl font-display font-bold">
                    {t("reservations.whatsappTitle")}
                  </h3>
                </div>
                <p className="font-body mt-2 opacity-90">
